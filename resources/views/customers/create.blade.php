...
@section('title', 'Yeni Müşteri — KVKK 360')
@section('page_title', 'Yeni Müşteri')
...
<form method="POST" action="{{ route('companies.customers.store', $company) }}">
    ...
    <div class="mt-4 d-flex gap-2">
        ...
        <a href="{{ route('companies.customers.index', $company) }}" class="btn btn-outline-secondary">İptal</a>
    </div>
</form>
</div></div>
@endsection
